...
#        ws.row(0).height=500
        ...
        if this.company_id and not this.department_id:
            ...
            ws.write_merge(1,1,var-4,var+4, this.department_id.name + ' , ' + this.department_id.company_id.name,style_header2)
        else :
...
#                    r6 = r6 + 23
                    ...
                    if this.company_id and not this.department_id:
                        ...
                        ws.write_merge(r1-4,r1-4,var-4,var+4, this.department_id.name + ' , ' + this.department_id.company_id.name,style_header2)
                    else :
